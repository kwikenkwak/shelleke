...
Item {
    id: root
    property bool shown: ClaudeUsage.available
    clip: true
    visible: width > 0 && height > 0
    implicitWidth: resourceRowLayout.x < 0 ? 0 : resourceRowLayout.implicitWidth
    implicitHeight: Appearance.sizes.barHeight
    property bool warning: ClaudeUsage.warning
    ...
    RowLayout {
        ...
        ClippedFilledCircularProgress {
            ...
            value: ClaudeUsage.sessionFraction
            implicitSize: 20
        ...
        Item {
            ...
            StyledText {
                ...
                font.pixelSize: Appearance.font.pixelSize.small
                text: `${Math.round(ClaudeUsage.sessionPercent).toString()}`
            }
        }
